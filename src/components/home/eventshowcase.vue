<template>
    <v-container class="pa-0">
        ...
        <v-layout wrap align-start justify-left row fill-height class="hidden-sm-and-down mb-4">
            ...
            <v-flex xs12 sm6 md3 lg3 v-for="(item,i) in upcomingEventsData" :key="i">
                <v-card 
                    flat
        ...
        <v-layout wrap align-left justify-left row fill-height class="hidden-md-and-up mb-3">
            <v-flex xs12 class="text-xs-center" v-if="showLoader">
                <v-progress-circular
                    :size="50"
                    color="blue"
            ...
            <v-flex xs12>
                <v-slide-y-reverse-transition>
                    <v-list two-line subheader v-show="showData">
                        <v-list-tile
                            v-for="(item,i) in upcomingEventsData" :key="i"
                            avatar
