<template>
    <v-container class="pa-0">
        ...
        <p class="google-font" style="font-size:170%; display:block;color:#0277bd">Past Events</p>
        ...
        <!-- upcoming parts starts -->
        <!-- upcoming parts starts -->
        <!-- upcoming parts starts -->
        <p class="google-font" style="font-size:170%; display:block;color:#0277bd">Upcoming Events</p>
        <v-layout wrap align-start justify-center row fill-height class="hidden-sm-and-down mb-4">
            <v-flex xs12 class="text-xs-center" v-if="showLoader">
                <v-progress-circular
                    :size="50"
